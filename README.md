...
###### A token is used to let an application know that the user has access to a protected route. Tokens are given to the user after they supply the correct login credentials.
- [x] What steps can you take in your web apps to keep your data secure?
###### Require the use of a token to access protected routes & making sure that the token isn't available in public repos.
- [x] Describe how web servers work.
###### Web servers process incoming requests and return data to users. 
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
###### .get for reading data, .post for creating data, .put for updating data, and .delete for deleting data.
